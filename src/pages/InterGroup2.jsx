    ...
    <>
      ...
      <div className="max-w-4xl mx-auto w-full px-5 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {papers.map(p => (
            <div key={p.id} className="card-base subj-inter flex items-center gap-5 text-left" onClick={() => setDash(p)}>
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">MCQ Bank{p.hasPyq ? ' · PYQ Available' : ''} · Practice Online</p>
              </div>
            </div>
          ))}
        </div>
