    ...
    <>
      ...
      <div className="max-w-4xl mx-auto w-full px-5 pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {papers.map((p, i) => (
            <div key={p.id} className="card-base subj-foundation group text-left" onClick={() => setDash(p)}>
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">
                  Paper {p.id}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between mt-auto pt-2 border-t border-slate-100">
                ...
                <span className="text-emerald-500 text-xs font-bold flex items-center gap-1 group-hover:gap-2 transition-all">
